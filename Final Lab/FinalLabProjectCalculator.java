        ...
        for (int row = 0; row < layout.length; row++) {
            for (int col = 0; col < layout[row].length; col++) {
                ...
                if (!text.isEmpty()) {
                    ...
                    // Updated: ± is now grouped with operator buttons
                    if (text.matches("[0-9.]")) {
                        button.setBackground(Color.decode("#323232")); // numbers & dot
                    } else {
                        button.setBackground(Color.decode("#3b3b3b")); // operators
                    }
                    ...
                    if (text.equals("0")) col++; // Skip one space for wide 0
                }
            }
        }
